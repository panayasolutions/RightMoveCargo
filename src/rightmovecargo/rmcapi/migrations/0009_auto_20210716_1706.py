    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('courier', models.ForeignKey('Courier',on_delete=django.db.models.deletion.CASCADE,db_column='CourierCode', max_length=10,null=True)),
                ...
                ('destinationcode', models.ForeignKey(db_column='DestinationCode', max_length=10, null=True, on_delete=django.db.models.deletion.CASCADE, to='rmcapi.Destination')),
            ],
            options={
                'db_table': 'mtPin',
                'managed': True,
