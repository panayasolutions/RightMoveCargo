...
from rightmovecargo.rmcapi.models import CompanyCourierMode, LocalSession, User, UserCompany
from rightmovecargo.rmcapi.serializers import CompanyCourierSerializer, UserCompanySerializer
from rightmovecargo.rmcapi.viewsets.baseviewset import BaseViewSet

class CompanyCourierViewSet(BaseViewSet):
    """
    API endpoint that allows groups to be viewed or edited.
    """
    queryset = CompanyCourierMode.objects.all()
    serializer_class = CompanyCourierSerializer;
