...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='User',
            fields=[
                ('id', models.CharField(auto_created=True, db_column='UserId', max_length=10, primary_key=True, serialize=False)),
                ('username', models.CharField(db_column='UserName', max_length=50, unique=True)),
                ('password', models.CharField(db_column='UserPassword', max_length=10)),
                ...
                ('email', models.CharField(db_column='EmailID', max_length=255, unique=True)),
